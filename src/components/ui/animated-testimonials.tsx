...
import img from "src/assets/hcoldplay.png";
...
export const AnimatedTestimonials = ({
  ...
  return (
    <div className={cn("w-full max-w-[960px] mx-auto px-4 md:px-8 lg:px-12 py-20", className)}>
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-14">
        ...
        <div className="flex justify-between flex-col py-4">
          ...
          >
            <h3 className="text-3xl font-bold text-foreground ml-5">
              {testimonials[active].name}
            </h3>
            <p className="text-base text-muted-foreground ml-5">
              {testimonials[active].designation}
            </p>
            <motion.p className="text-xl text-muted-foreground mt-8 ml-5">
